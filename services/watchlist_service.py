...
def add_to_watchlist(user_id, film_id, public=True):
    """
    Save a film to a user's watchlist with an explicit visibility toggle.
...
def remove_from_watchlist(user_id, film_id):
    ...
    Returns:
        bool: True if the entry was successfully removed.
...
def get_watchlist(user_id):
    """
    Return all films on a user's watchlist sorted by date added descending.
